...
> 💡 Please refer to the release notes of the major version [`v2.1.0`](https://github.com/sighupio/fury-kubernetes-monitoring/releases/tag/v2.1.0) if you are upgrading from a version `< v2.0.1`
